...
def list_cases() -> typing.List[TestCaseBuilder]:
    ...
    def lso_filter_tests():
        ...
        mask-normalized filter with downsampled output. The filtered serial dump under
        <case>/lso/D is packed into the golden file alongside the unfiltered output."""
