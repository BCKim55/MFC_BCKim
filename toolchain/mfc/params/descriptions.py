...
DESCRIPTIONS = {
    ...
    "lso_pp2_n_passes_x": "Number of stage-2 LSO filter passes in x (derived; non-zero when a wide target is split across two cascades)",
    "lso_pp2_n_passes_y": "Number of stage-2 LSO filter passes in y (derived; non-zero when a wide target is split across two cascades)",
    "lso_pp2_n_passes_z": "Number of stage-2 LSO filter passes in z (derived; non-zero when a wide target is split across two cascades)",
    "lso_pp2_a_x": "Per-pass stage-2 LSO stencil coefficients in x (derived by the toolchain; do not set)",
    "lso_pp2_a_y": "Per-pass stage-2 LSO stencil coefficients in y (derived by the toolchain; do not set)",
    "lso_pp2_a_z": "Per-pass stage-2 LSO stencil coefficients in z (derived by the toolchain; do not set)",
