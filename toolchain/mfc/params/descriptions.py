...
DESCRIPTIONS = {
    ...
    "lso_filter": "Apply a least-squares optimized (LSO) 9-point FIR Gaussian filter to the conserved variables at each save step (in-situ)",
    "lso_filter_wrt": "Write the LSO-filtered conserved variables (lustre_lso_*.dat) alongside the unfiltered restart data",
    "filter_sigma": "Standard deviation of the in-situ Gaussian filter kernel in physical units (default: patch_ib(1)%radius, i.e. d_p/2)",
    "lso_down_sample_factor": "Coarsening factor for the LSO-filtered output grid (1 = full resolution)",
    "lso_filter_sigma_in": "Width of the already-filtered input data when post_process widens it further (defaults to filter_sigma)",
    "lso_n_passes_x": "Number of in-situ LSO filter passes in x (derived by the toolchain; do not set)",
    "lso_n_passes_y": "Number of in-situ LSO filter passes in y (derived by the toolchain; do not set)",
    "lso_n_passes_z": "Number of in-situ LSO filter passes in z (derived by the toolchain; do not set)",
    "lso_a_x": "Per-pass in-situ LSO stencil coefficients in x (derived by the toolchain; do not set)",
    "lso_a_y": "Per-pass in-situ LSO stencil coefficients in y (derived by the toolchain; do not set)",
    "lso_a_z": "Per-pass in-situ LSO stencil coefficients in z (derived by the toolchain; do not set)",
    "lso2_n_passes_x": "Stage-2 (coarse grid) LSO passes in x (derived by the toolchain; do not set)",
    "lso2_n_passes_y": "Stage-2 (coarse grid) LSO passes in y (derived by the toolchain; do not set)",
    "lso2_n_passes_z": "Stage-2 (coarse grid) LSO passes in z (derived by the toolchain; do not set)",
    "lso2_a_x": "Stage-2 per-pass LSO stencil coefficients in x (derived by the toolchain; do not set)",
    "lso2_a_y": "Stage-2 per-pass LSO stencil coefficients in y (derived by the toolchain; do not set)",
    "lso2_a_z": "Stage-2 per-pass LSO stencil coefficients in z (derived by the toolchain; do not set)",
    "lso_pp_filter": "Apply a least-squares optimized (LSO) 9-point FIR Gaussian filter to the conserved variables in post_process before writing output",
    "lso_filter_sigma_target": "Standard deviation of the target Gaussian filter kernel in physical units (LSO post_process filter)",
    "lso_pp_n_passes_x": "Number of LSO filter passes in x (derived by the toolchain; do not set)",
    "lso_pp_n_passes_y": "Number of LSO filter passes in y (derived by the toolchain; do not set)",
    "lso_pp_n_passes_z": "Number of LSO filter passes in z (derived by the toolchain; do not set)",
    "lso_pp_a_x": "Per-pass LSO stencil coefficients in x (derived by the toolchain; do not set)",
    "lso_pp_a_y": "Per-pass LSO stencil coefficients in y (derived by the toolchain; do not set)",
    "lso_pp_a_z": "Per-pass LSO stencil coefficients in z (derived by the toolchain; do not set)",
